...
public class MenuItemDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*if (savedInstanceState == null) {
            ...
            String activityID = getIntent().getStringExtra(MenuItemDetailFragment.ARG_ITEM_ID);
            arguments.putString(MenuItemDetailFragment.ARG_ITEM_ID,activityID);
            MenuItemDetailFragment fragment = new MenuItemDetailFragment();
            fragment.setArguments(arguments);
            if(!activityID.equals(MenuContent.MENUITEM_ABOUT_ID))
